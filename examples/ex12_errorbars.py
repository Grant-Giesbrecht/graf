...
g1 = Graf(fig=fig1)
g1.write_graf("ex12_yerr.graf")

g1b = Graf()
g1b.read_graf("ex12_yerr.graf")
fig1b = g1b.to_fig()
...
g2 = Graf(fig=fig2)
g2.write_graf("ex12_xyerr.graf")

g2b = Graf()
g2b.read_graf("ex12_xyerr.graf")
fig2b = g2b.to_fig()
...
g3 = Graf(fig=fig3)
g3.write_graf("ex12_mixed.graf")

g3b = Graf()
g3b.read_graf("ex12_mixed.graf")
fig3b = g3b.to_fig()
